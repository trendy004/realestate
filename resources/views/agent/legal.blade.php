...
<div class="main-container">
    ...
    <aside data-mcs-theme="minimal-dark" style="background-image: url{{asset('build/images/backgrounds/11.jpg')}}" class="main-sidebar closed mCustomScrollbar">
        <ul class="list-unstyled navigation mb-0">
            ...
            <li><a href="{{ url('/agent/assets_report') }}" class="active bubble"><i class="ti-bar-chart"></i> Reports</a></li>
            {{--<li><a href="{{ url('/agent/notification_list') }}" class="bubble"><i class="ti-book"></i>Notification</a></li>--}}
            <li><a href="{{ route('logout') }}" class="bubble" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"> Logout </a>
    ...
    <div class="page-container">
        <div class="page-header clearfix">
            <div class="pull-left">
                ...
                <a href="{{url('agent/legal')}}" class="active mb-15 btn btn-raised btn-primary">Legal</a>
            </div>
        </div>
