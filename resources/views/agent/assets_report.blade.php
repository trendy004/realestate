      ...
      <div class="page-container">
        <div class="page-header clearfix">
          <div class="pull-left">
            ...
            <a href="{{url('agent/assets_report')}}" class="active mb-15 btn btn-raised btn-primary">Assets</a>
        ...
        <div class="page-content container-fluid">
          <div class="widget">
            <div class="widget-heading">
              <h3 class="widget-title">Assets</h3>
            </div>
            <div class="widget-body">
             ...
             @foreach($assets as $key => $asset)
                  <tr>
                    ...
                    <td>{{ $asset->quantity_occupied  }}</td>
                    <td>{{ $asset->quantity_left }}</td>
                  </tr>
               @endforeach
                </tbody>
              </table>
