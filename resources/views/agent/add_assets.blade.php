      ...
      <div class="page-container">
        <div class="page-header clearfix">
          <div class="pull-left">
            ...
            <a href="{{ url('agent/add_assets') }}" class="active mb-15 btn btn-raised btn-primary">Add Assets</a>
          </div>
        </div>
            ...
            <div class="col-lg-12">
              <div class="widget">
                <div class="widget-heading">
                  <h3 class="widget-title">Add Assets</h3>
                </div>
                <div class="widget-body">
                  ...
                  @endif
                  <form  method="post" action="add_assets" data-toggle="validator">
                    {{ csrf_field() }}
                    <div class="row">
                      <div class="col-md-8">
                        <div class="form-group">
                          <label for="txtMovieTitle">Description</label>
                          <input id="txtMovieTitle" type="text" class="form-control" name="description" required="">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input id="txtDirector" type="number" class="form-control" name="quantity_added" required="">
                          <div class="help-block with-errors"></div>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input id="txtWriter" type="number" class="form-control" name="price" required="">
                          <div class="help-block with-errors"></div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input id="txtWebsite" type="text" class="form-control" name="address" required="">
                          <div class="help-block with-errors"></div>
                        </div>
                      </div>
