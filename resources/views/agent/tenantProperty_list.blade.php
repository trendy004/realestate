    ...
    <div class="main-container">
      ...
      <div class="page-container">
        <div class="page-header clearfix">
          <div class="pull-left">
            <a href="{{ url('agent/tenantProperty_list') }}" class="active mb-15 btn btn-raised btn-primary">Tenants Property List</a>
        ...
        <div class="page-content container-fluid">
          ...
          <div class="widget">
            <div class="widget-heading">
              <h3 class="widget-title">Tenants Property List</h3>
            </div>
              ...
              <table id="customer-list" style="width: 100%" class="table table-hover dt-responsive nowrap">
                ...
                @foreach($tenantProperties as $key => $tenantProperty)
                  ...
                  <tr>
                    ...
                    <td>{{ $tenantProperty['designation'] }} {{ $tenantProperty['firstname'] }} {{
                    $tenantProperty['lastname'] }}</td>
                    <td>{{ $tenantProperty->getName($tenantProperty['category_id']) }}</td>
                    <td>{{ $tenantProperty['description'] }}</td>
                    <td>{{ $tenantProperty['address'] }}</td>
                    <td>{{ $tenantProperty['occupation_date'] }}</td>
                    <td class="text-center">
                      <div role="group" aria-label="Basic example" class="btn-group btn-group-sm">
                        <a href="{{ url('agent/edit_tenantProperty/'. $tenantProperty['id']) }}" type="button"
